...
int main2()
{
	long long S;//易感者
	long long I;//感染者
	long long n;//输入第n天的需求
	long long R = 0;//恢复者    注意，恢复者不会二次感染
	...
	for (int i = 0; i < n; i++)
	{
		c = ceil(a * S * I);//求每一天新感染的人    向上取整
		d = ceil(b * I);    //求每一天新恢复的人    向上取整
		if (c >= S)          //如果被感染的人大于易感者，则全员被感染，则S变为0；I变为I加S减去d；R变为R加d
		{
			I = I + S - d;
			S = 0;
			R = R + d;
